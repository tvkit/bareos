...
static int32_t fmtstr(char *buffer,
                      ...
                      int min,
                      int max);
static int32_t fmtwstr(char *buffer,
                       int32_t currlen,
                       int32_t maxlen,
                       const wchar_t *value,
                       int flags,
                       int min,
                       int max);
static int32_t fmtint(char *buffer,
                      int32_t currlen,
                      int32_t maxlen,
                      int64_t value,
                      int base,
                     ...
                     int flags)
{
  ...
  if (iplace == (int)sizeof(fconvert)) { iplace--; }
  iconvert[iplace] = 0;
  ...
  if (r_length < dec_pt) dec_pt = r_length;
  ...
  if (dec_pt <= 0) {
    ...
    while (r_length) { fconvert[fplace++] = result[--r_length]; }
