  ...
  if (hLib) {
    ...
    if (g_platform_id != VER_PLATFORM_WIN32_WINDOWS) {
      ...
      p_GetFileAttributesExW =
          (t_GetFileAttributesExW)GetProcAddress(hLib, "GetFileAttributesExW");
      ...
      p_GetCurrentDirectoryW =
          (t_GetCurrentDirectoryW)GetProcAddress(hLib, "GetCurrentDirectoryW");
      p_SetCurrentDirectoryW =
          (t_SetCurrentDirectoryW)GetProcAddress(hLib, "SetCurrentDirectoryW");
  ...
  if (g_platform_id != VER_PLATFORM_WIN32_WINDOWS) {
    ...
    if (hLib) {
      ...
      p_LookupPrivilegeValue =
          (t_LookupPrivilegeValue)GetProcAddress(hLib, "LookupPrivilegeValueA");
      ...
      p_ReadEncryptedFileRaw =
          (t_ReadEncryptedFileRaw)GetProcAddress(hLib, "ReadEncryptedFileRaw");
