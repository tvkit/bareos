...
struct Resources {
  ...
  directordaemon::StorageResource
      *pstore; /**< Selected paired storage (saved wstore or rstore) */
  ...
  alist *pstorage;         /**< Paired storage possibilities (saved wstorage or
                              rstorage) */
...
class JobControlRecord {
 ...
 public:
  JobControlRecord() { Dmsg0(100, "Contruct JobControlRecord\n"); }
  ...
  bool suppress_output;  /**< Set if this JobControlRecord should not output any
                            Jmsgs */
  JobControlRecord
      *cjcr;        /**< Controlling JobControlRecord when this is a slave
                     * JobControlRecord being        controlled by another JobControlRecord
