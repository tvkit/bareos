...
static inline void PrintConfigRun(ResourceItem *item, PoolMem &cfg_str)
{
  ...
  int i, nr_items;
  int interval_start;
  char *weekdays[] = {(char *)"Sun", (char *)"Mon", (char *)"Tue",
                      (char *)"Wed", (char *)"Thu", (char *)"Fri",
                      (char *)"Sat"};
  char *months[] = {(char *)"Jan", (char *)"Feb", (char *)"Mar", (char *)"Apr",
                    (char *)"May", (char *)"Jun", (char *)"Jul", (char *)"Aug",
                    (char *)"Sep", (char *)"Oct", (char *)"Nov", (char *)"Dec"};
  char *ordinals[] = {(char *)"1st", (char *)"2nd", (char *)"3rd",
                      (char *)"4th", (char *)"5th"};
  ...
  switch (type) {
    ...
    case R_STORAGE:
      if (!(res = (UnionOfResources *)my_config->GetResWithName(
        ...
        res->res_store.rss = (runtime_storage_status_t *)malloc(
            sizeof(runtime_storage_status_t));
                                            ...
                                            const char *param)
{
  ...
  switch (param[0]) {
    ...
    case 'p':
      ...
      break;
    case 'w':
      if (jcr->res.wstore) { return jcr->res.wstore->name(); }
      break;
    case 'x':
